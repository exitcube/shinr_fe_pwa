  ...
  const serviceProviders: ServiceProvider[] = [
    {
      ...
      description:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, labore voluptate velit esse cillum dolore eu fugiat nulla pariatur.",
      services: [
        {
          id: 1,
          name: "Premium Detailing",
          description:
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, labore voluptate velit esse cillum dolore eu fugiat nulla pariatur, sit amet mollis.",
          price: "599",
        },
        {
          id: 2,
    ...
    },
    {
      ...
      imageUrl: "/assets/images/car_image.png",
      description:
        "Professional car care services with experienced technicians and quality products.",
      services: [
        {
          id: 1,
          name: "Basic Wash",
        ...
        },
        {
          ...
          description:
            "Deep interior cleaning including vacuum and dashboard polish.",
          price: "499",
        },
      ],
    },
    {
      ...
      imageUrl: "/assets/images/car_image.png",
      description:
        "Premium car spa services with state-of-the-art equipment and certified professionals.",
      services: [
        {
          id: 1,
          name: "Deluxe Wash",
    ...
    },
    {
      ...
      imageUrl: "/assets/images/car_image.png",
      description:
        "Fast and affordable car cleaning services for busy professionals.",
      services: [
        {
          id: 1,
          name: "Express Wash",
