...
export const AddLocationModal: React.FC<IProps> = ({ isOpen, onClose }) => {
      ...
      >
        ...
        <div className="px-4">
          ...
          <div className="flex items-start justify-between mt-3">
            ...
            <button className="px-3 py-1 text-[12px] border rounded-full border-[#128C7E] text-[#128C7E] font-medium">
              Change
            </button>
          </div>
        </div>
        ...
        {/* Form */}
        <div
          className="px-4 mt-4 pb-28 overflow-y-auto text-black"
        ...
        >
          ...
          <input
            className="w-full mb-3 rounded-full border border-gray-300 px-4 py-2 text-sm focus:outline-none"
          ...
          <input
            className="w-full mb-4 rounded-full border border-gray-300 px-4 py-2 text-sm focus:outline-none"
          ...
          <input
            className="w-full mb-6 rounded-full border border-gray-300 px-4 py-2 text-sm focus:outline-none"
