...
const WalletPageContent = () => {
  ...
  return (
    <>
      <motion.div
        className="w-full flex items-center justify-center bg-[#F5F5F5] overflow-y-scroll no-scrollbar pb-30 pt-5"
        initial={{ y: 100, opacity: 0, scale: 0.95 }}
        animate={{ y: 0, opacity: 1, scale: 1 }}
        transition={{ duration: 0.5, ease: "easeOut" }}
      >
        <div className="bg-gray-100 font-poppins w-full max-w-lg px-4">
          <WalletBalance />
          <RewardBanner />
